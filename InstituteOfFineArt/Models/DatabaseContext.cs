        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Account>(entity =>
            {
                entity.HasKey(e => e.IdAcc)
                    .HasName("PK__account__6BE8F064A576D676");
            ...
            modelBuilder.Entity<Bill>(entity =>
            {
                entity.HasKey(e => e.IdOrder)
                    .HasName("PK__bill__DD5B8F3F3BEF24B9");
            ...
            modelBuilder.Entity<Comment>(entity =>
            {
                entity.HasKey(e => e.IdComment)
                    .HasName("PK__comment__7E14AC85A7F65D05");
            ...
            modelBuilder.Entity<Competition>(entity =>
            {
                entity.HasKey(e => e.IdCom)
                    .HasName("PK__competit__D6967171F6AA487A");
            ...
            modelBuilder.Entity<Feedback>(entity =>
            {
                entity.HasKey(e => e.IdFeedback)
                    .HasName("PK__feedback__36BC8630472BB28F");
            ...
            modelBuilder.Entity<OrderDetail>(entity =>
            {
                entity.HasKey(e => new { e.IdOrder, e.IdTest })
                    .HasName("PK__orderDet__7136BDBBE9447DEB");
            ...
            modelBuilder.Entity<Role>(entity =>
            {
                entity.HasKey(e => e.IdRole)
                    .HasName("PK__roles__3D48441DB432E0F8");
            ...
            modelBuilder.Entity<Test>(entity =>
            {
                entity.HasKey(e => e.IdTest)
                    .HasName("PK__test__C6D3284B81FBFB8C");
            ...
            modelBuilder.Entity<TestCore>(entity =>
            {
                entity.HasKey(e => new { e.IdTest, e.IdCom })
                    .HasName("PK__test_cor__CBBA4F5C9B4A43A3");
            ...
            modelBuilder.Entity<UserRole>(entity =>
            {
                entity.HasKey(e => new { e.IdRole, e.IdAcc })
                    .HasName("PK__user_rol__6BF6CB1B6643D8BF");
